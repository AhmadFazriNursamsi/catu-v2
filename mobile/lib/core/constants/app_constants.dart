...
class AppConstants {
  ...
  static const String appVersion = 'v2.5.0-build.20260824.170712';
  static const String apiBaseUrl = 'http://10.251.212.54:3005'; // NestJS Local Server (Docker Port 3005)
