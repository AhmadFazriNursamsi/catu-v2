                ...
                children: [
                  Expanded(
                    child: OutlinedButton.icon(
                      ...
                      label: const FittedBox(
                        ...
                        child: Text('Tolak', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12.5)),
                      ),
                    ),
                  ),
                  const SizedBox(width: 10),
                  Expanded(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      label: const FittedBox(
                        fit: BoxFit.scaleDown,
                        child: Text('Setujui Romo', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12.5)),
                      ),
                    ),
                  ),
                ],
