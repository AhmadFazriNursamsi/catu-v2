                  ...
                  ` : list.map(u => {
                    ...
                    return `
                      <tr class="hover:bg-slate-50/80 transition duration-150 group">
                        <td class="px-6 py-4">
                          <p class="font-bold text-slate-900 text-sm tracking-tight">${u.full_name || 'Pengurus'}</p>
                        ...
                        <td class="px-6 py-4">
                          <div class="space-y-1">
                            <div class="inline-flex items-center px-2.5 py-1 rounded-lg bg-slate-100 text-slate-700 font-bold border border-slate-200 text-xs shadow-sm">
                              <span class="truncate max-w-[170px]">${u.lingkungan_name || '-'}</span>
                            </div>
                            <div class="text-[11px] font-bold text-slate-500 pl-1">
                              <span class="truncate max-w-[170px]">${u.paroki_name || '-'}</span>
                            </div>
                          </div>
                        </td>
                        <td class="px-6 py-4 text-center">
                          ${isExpired ? `
                            <span class="inline-flex items-center space-x-1.5 px-3 py-1 rounded-full bg-rose-50 text-rose-700 border border-rose-200 font-bold text-[11px] shadow-sm">
